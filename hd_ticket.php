...
if ($gpermHandler->checkRight($perm_name, $perm_itemid, $groups, $module_id)) {
    ...
    if ('new' == $TicketState) {
        ...
        $GLOBALS['xoopsOption']['template_main'] = 'obsclient_hd_ticket-new.html';
        ...
        if ($TicketUID == $UID) {
            ...
            $GLOBALS['xoopsOption']['template_main'] = 'obsclient_hd_ticket-update.html';
            ...
            redirect_header('index.php', 2, _NOT_AUTH);
        }
    }
} else {
